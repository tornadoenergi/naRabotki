...
public class Const {
    ...
    public static final String TEST_TEST_ID = "testsid";
    ...
    public static final String RESULT_USER = "userid";
    public static final String RESULT_TEST_ID = "testid";
    public static final String RESULT_CORRECT = "results";
    public static final String RESULT_NAME_TEST = "name";
